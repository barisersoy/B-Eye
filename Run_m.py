...
def run():
	...
	ap.add_argument("-c", "--confidence", type=float, default=0.4, 
		help="minimum probability to filter weak detections") ## confidence default 0.4
	...
	net = cv2.dnn.readNetFromCaffe(args["prototxt"], args["model"])	# load our serialized model from disk
...
if config.Scheduler:
	##Runs for every 1 second schedule.every(1).seconds.do(run) ////// Runs at every day (09:00 am).
